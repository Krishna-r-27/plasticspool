...
import Badge from '../../../assets/img/plasticspool-hi-tech-plast-ecofriendly-badge.svg';
...
const Footer = () => {
    ...
    const verticalGradient = {
        background: "linear-gradient(to bottom, rgba(156, 163, 175, 0) 0%, rgba(156, 163, 175, 0.8) 50%, rgba(156, 163, 175, 0) 100%)"
    };
                    ...
                    <div className="space-y-6 relative lg:pr-10 sm:col-span-2 lg:col-span-1">
                        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
                            <picture>
                                ...
                                <img src={logoPng} alt="Hi-Tech Plast Logo" className="h-14 w-auto" />
                            </picture>
                            <img src={Badge} alt="Hi-Tech Plast Ecofriendly" className="h-14 w-auto"/>
                        </div>
                        <p className="text-[#555555] text-base leading-relaxed max-w-2xl lg:max-w-sm mx-auto lg:mx-0">
                            Hi-Tech Plast was incorporated to manufacture cost-effective and efficient Plastic Reels for various purposes. Our company is admired for our quality products and prompt services by our valued clients.
                        </p>
                        <div className="absolute top-4 bottom-4 w-[2px] right-0 hidden lg:block" style={verticalGradient}></div>
                    </div>

                    {/* Column 2: Quick Links */}
                    <div className="lg:px-16 relative md:text-start">
                        <h4 className="text-[#001933] font-unbounded text-2xl font-bold mb-8 text-center lg:text-start">Quick Links</h4>
                        <ul className="space-y-3 w-fit mx-auto lg:mx-0">
                            {quickLinks.map((link) => (
